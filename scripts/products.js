export const catalogPrincipal = [
    ...
    {
        cod: 2,
        name: "Robô Coelha Dançante",
        price: 129.99,
        descricao: "O Robô Coelha Dançante é a companheira perfeita para crianças que adoram música e diversão! Com movimentos encantadores, essa robô coelho não só dança com alegria, mas também toca uma guitarra de brinquedo, proporcionando entretenimento interativo. Este brinquedo é a combinação perfeita de música, dança e imaginação para as crianças explorarem e se divertirem.",
    ...
    {
        cod: 4,
        name: "Encanto de Chá da Tarde",
        price: 39.99,
        descricao: "O Conjunto Encanto de Chá da Tarde é a chave para brincadeiras mágicas de faz de conta. Com xícaras, talheres, cafés e lanches em miniatura, as crianças podem criar seus próprios chás da tarde encantadores. Estimule a imaginação e a sociabilidade enquanto desfrutam de horas de diversão criativa.",
        idade: "A partir de 3 anos",
    ...
    {
        cod: 7,
        name: "Minha Sorveteria Divertida",
        price: 34.99,
        descricao: "Com o Conjunto Minha Sorveteria Divertida, as crianças podem criar suas próprias sorveterias imaginárias. Inclui picolés, casquinhas e dinheiro de brinquedo para estimular a criatividade e o aprendizado financeiro enquanto se divertem. Ideal para crianças a partir de 4 anos, é perfeito para brincadeiras de faz de conta e desenvolvimento de habilidades sociais.",
        itens: "",
    ...
    {
        cod: 8,
        name: "Mercadinho Play",
        price: 59.95,
        descricao: "O Mercadinho Play é o kit perfeito para crianças que adoram brincar de mercadinho. Com leitor de preço, calculadora de faz de conta, dinheiro de brinquedo e balança, este conjunto proporciona horas de diversão criativa enquanto ajuda as crianças a aprender sobre números e trocas. Ideal para crianças a partir de 3 anos.",
        itens: "",
        idade:"A partir de 3 anos",
